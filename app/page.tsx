...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen dark:bg-neutral-950 bg-white">
      ...
      <section className="flex items-center justify-center pt-32 pb-16 px-4">
      ...
      <section className="space-y-12 w-full py-16 px-4">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <BlurFade key={feature.title} delay={0.3 + index * 0.1} inView>
                <div className="bg-white dark:bg-neutral-800 p-6 rounded-xl border border-neutral-200 dark:border-neutral-700 hover:shadow-lg transition-all">
      ...
      {/* Pricing Section */}
      <section className="py-16 px-4 border-t border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12">
            <BlurFadeText>
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl mb-3">Pricing Tailored To Your Fit</h2>
            </BlurFadeText>
          ...
          >
            <BlurFadeText>
              <h2 className="text-3xl md:text-4xl font-bold">
                Ready to create your own stunning logo?
              </h2>
            </BlurFadeText>

            <div className="pt-6">
              <Link href="/sign-up">
                <Button size="lg" className="text-lg px-8 py-7 rounded-full shadow-lg hover:shadow-xl transition-all">
      ...
      {/* Simple Footer */}
      <footer className="py-8 px-4 border-t dark:border-neutral-800">
