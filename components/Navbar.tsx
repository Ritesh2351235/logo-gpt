...
export function Navbar({ className, variant = "landing" }: NavbarProps) {
  ...
  if (variant === "landing") {
    return (
      <header className={cn("sticky top-0 z-50 w-full border-b border-neutral-200 dark:border-neutral-800 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-sm", className)}>
        <div className="container flex h-16 max-w-screen-xl items-center px-3 sm:px-6">
  ...
  return (
    <header className={cn("sticky top-0 z-50 w-full border-b border-neutral-200 dark:border-neutral-800 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-sm", className)}>
      <div className="container flex h-auto min-h-16 max-w-screen-xl items-center px-3 sm:px-6 py-2 sm:py-0">
        <Link href="/dashboard" className="flex items-center gap-2">
          <span className="text-xl font-bold tracking-tight">LogoGPT</span>
        </Link>
        <div className="flex items-center gap-5 sm:gap-6 text-sm font-medium ml-8">
          <Link
            href="/dashboard"
